...
Über den Reiter **Haltestellenkarte** steht zusätzlich eine OpenStreetMap-Karte bereit. Die vollständige StopPoint-Liste wird unabhängig von den aktiven Linien geladen: Jeder Steig mit Koordinaten erscheint als leerer Ring, also auch Steige, die aktuell von keiner Linie bedient werden. Sobald mindestens ein Fahrzeug einen Steig als nächste Passage meldet, wird der Ring als leuchtender Punkt ausgefüllt. Die Zahl im Lichtpunkt zeigt, wie viele Fahrzeuge denselben Steig als nächstes anfahren; ein Klick zeigt Linie und Fahrzeugnummer.
