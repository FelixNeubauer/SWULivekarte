...
Die Antwort wird entsprechend dem SWU-Format aus `VehicleTrip.TripData` gelesen. Angezeigt werden ausschließlich Einträge mit `IsActive: true`; Fahrzeugnummer, Linie und Fahrtziel stammen aus `VehicleNumber`, `JourneyData.RouteNumber` und `JourneyData.DepartureDirectionText`.
